...
class Downloader:
    ...
    def sync_semesters(self, semesters: Sequence[Semester]) -> None:
        ...
        self.progress_prepare.update(
            task_id=self.semesters_task_id, total=len(semesters)
        )
        for semester in semesters:
    ...
    def sync_documents(
        ...
        self.progress_prepare.update(
            task_id=self.documents_task_id, total=len(documents)
        )
    ...
    def sync_homeworks(
        ...
        self.progress_prepare.update(
            task_id=self.homeworks_task_id, total=len(homeworks)
        )
